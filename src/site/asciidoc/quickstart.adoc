...
.Example.java
----
package com.github.dakusui.jcunit_pcond.examples;

// <1>
import static com.github.dakusui.jcunit_pcond.Assertions.precondition;
import static com.github.dakusui.jcunit_pcond.Postconditions.ensureNonNull;
import static com.github.dakusui.jcunit_pcond.Preconditions.requireArgument;
import static com.github.dakusui.jcunit_pcond.functions.Functions.*;
import static com.github.dakusui.jcunit_pcond.functions.Predicates.*;
