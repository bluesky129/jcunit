...
public class GenerationTestBase {
  ...
  protected void exerciseGeneration(FactorSpaceSpecWithConstraints factorSpaceSpec, int strength, int times) {
    assertCoveringArray(
  ...
  private Report exerciseGeneration(FactorSpaceSpecWithConstraints factorSpaceSpec, int strength) {
