...
public class JoinCA2$2$10_CA2$2$20 {
  private List<Tuple> lhs    = generateWithIpoGplus(new CompatFactorSpaceSpecWithConstraints("LHS").addFactors(2, 10).build(), 2);
  private List<Tuple> rhs    = generateWithIpoGplus(new CompatFactorSpaceSpecWithConstraints("RHS").addFactors(2, 20).build(), 2);
