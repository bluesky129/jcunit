...
public class CoveringArrayQualityTest extends GenerationTestBase {
  ...
  public void generate3_3$t2() {
    exerciseGeneration(new CompatFactorSpaceSpecWithConstraints("F").addFactors(3, 3), 2, 0);
  }

  @Test
  public void generate3_4$t2() {
    exerciseGeneration(new CompatFactorSpaceSpecWithConstraints("F").addFactors(3, 4), 2, 0);
  }

  @Test
  public void generate3_5$t2() {
    // [{F-02=2, F-04=1}, {F-03=0, F-04=1}]
    exerciseGeneration(new CompatFactorSpaceSpecWithConstraints("F").addFactors(3, 5), 2, 0);
  }


  @Test
  public void generate2_3$t3() {
    exerciseGeneration(new CompatFactorSpaceSpecWithConstraints("F").addFactors(2, 3), 3, 0);
  }
