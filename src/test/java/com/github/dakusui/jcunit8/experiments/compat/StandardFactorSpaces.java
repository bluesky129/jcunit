...
public class StandardFactorSpaces extends GenerationTestBase {
  ...
  public void generate3_4() {
    exerciseGeneration(
        new CompatFactorSpaceSpecWithConstraints("F1")
            .addFactors(3, 4),
        2,
        1);
  }
  ...
  public void generate3_13() {
    exerciseGeneration(
        new CompatFactorSpaceSpecWithConstraints("F2")
            .addFactors(3, 13),
        2,
        1);
  }
  ...
  public void generate4_15$3_17$2_29() {
    exerciseGeneration(
        new CompatFactorSpaceSpecWithConstraints("F3")
            .addFactors(4, 15)
            .addFactors(3, 17)
            .addFactors(2, 29),
        2,
  ...
  public void generate4_1$3_39$2_35() {
    exerciseGeneration(
        new CompatFactorSpaceSpecWithConstraints("F4")
            .addFactors(4, 1)
            .addFactors(3, 39)
            .addFactors(2, 35),
        2,
  ...
  public void generate2_100() {
    exerciseGeneration(
        new CompatFactorSpaceSpecWithConstraints("F5")
            .addFactors(2, 100),
        2,
        1);
  }
  ...
  public void generate10_20() {
    exerciseGeneration(
        new CompatFactorSpaceSpecWithConstraints("F6")
            .addFactors(10, 20),
        2,
        1);
  }
