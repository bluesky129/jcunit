...
public class JoinSandbox3 {
  ...
  public void test() throws ExecutionException, InterruptedException {
    FactorSpaceSpecWithConstraints spec1 = new CompatFactorSpaceSpecWithConstraints("A").addFactors(2, 40);
    FactorSpaceSpecWithConstraints spec2 = new CompatFactorSpaceSpecWithConstraints("B").addFactors(2, 30);
    FactorSpaceSpecWithConstraints spec3 = new CompatFactorSpaceSpecWithConstraints("C").addFactors(2, 30);
  ...
  private List<Tuple> generateCoveringArrayByCascading(FactorSpaceSpecWithConstraints spec1, FactorSpaceSpecWithConstraints spec2, FactorSpaceSpecWithConstraints spec3, ExecutorService threadPool) throws InterruptedException, ExecutionException {
