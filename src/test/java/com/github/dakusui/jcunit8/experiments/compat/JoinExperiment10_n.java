...
public class JoinExperiment10_n extends JoinExperimentBase {
  ...
  public void whenJoinWith10_5$thenLetsSee() {
    FactorSpaceSpecWithConstraints rhsSpec = new CompatFactorSpaceSpecWithConstraints("R").addFactors(10, 10);
  ...
  protected FactorSpaceSpecWithConstraints lhsFactorSpaceSpec() {
    return new CompatFactorSpaceSpecWithConstraints("L").addFactors(10, 10);
  }
}
