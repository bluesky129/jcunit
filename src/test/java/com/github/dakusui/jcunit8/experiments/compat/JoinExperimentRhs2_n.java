...
public abstract class JoinExperimentRhs2_n extends JoinExperimentBase {
  ...
  public void whenJoinWith2_50$thenLetsSee() {
    FactorSpaceSpecWithConstraints rSpec = factorSpeceSpec("R", 50);
    final FactorSpace r = rSpec.build();
    exerciseJoin(
        10, rSpec, generateWithIpoGplus(
            r, strength()
  ...
  public void whenJoinWith2_60$thenLetsSee() {
    FactorSpaceSpecWithConstraints rSpec = factorSpeceSpec("R", 60);
    final FactorSpace r = rSpec.build();
    exerciseJoin(
        10, rSpec, generateWithIpoGplus(
            r, strength()
  ...
  public void whenJoinWith2_70$thenLetsSee() {
    FactorSpaceSpecWithConstraints rSpec = factorSpeceSpec("R", 70);
    final FactorSpace r = rSpec.build();
    exerciseJoin(
        10, rSpec, generateWithIpoGplus(
            r, strength()
  ...
  public void whenJoinWith2_80$thenLetsSee() {
    FactorSpaceSpecWithConstraints rSpec = factorSpeceSpec("R", 80);
    final FactorSpace r = rSpec.build();
    exerciseJoin(
        10, rSpec, generateWithIpoGplus(
            r, strength()
  ...
  public void whenJoinWith2_90$thenLetsSee() {
    FactorSpaceSpecWithConstraints rSpec = factorSpeceSpec("R", 90);
    final FactorSpace r = rSpec.build();
    exerciseJoin(
        10, rSpec, generateWithIpoGplus(
            r, strength()
